...
// https://github.com/gbif/checklistbank/blob/master/checklistbank-nub/src/main/java/org/gbif/checklistbank/lucene/ScientificNameNormalizerFilter.java
 ...
 * <p>
 * When using it with tokens containing whitespace and representing entire scientific names as
 * generated by the KeywordTokenizer one should set fullNameTokens=true to keep monomials & genera
 * mostly untouched.
 */
public class ScientificNameNormalizerFilter extends TokenFilter {
  ...
  /**
   * @param fullNameTokens if true the name normalization is done on the entire token. If false just
   *                       on the epithets, leaving the genus part untouched
