...
// https://github.com/gbif/checklistbank/blob/master/checklistbank-common/src/main/java/org/gbif/checklistbank/utils/SciNameNormalizer.java
...
public class SciNameNormalizer {
  ...
  private static final Pattern removeHybridSignEpithet = Pattern.compile(
      "(?:^|\\s)(?:×\\s*|[xX]\\s+)([^A-Z])");
  private SciNameNormalizer() {
  ...
  /**
   * Normalizes and entire scientific name, keeping monomials or the first genus part rather
   * unchanged, applying the more drastic normalization incl stemming to the remainder of the name
   * only.
   */
  ...
  /**
   * Normalizes and entire scientific name, keeping monomials or the first genus part rather
   * unchanged, applying the more drastic normalization to the remainder of the name only.
   */
